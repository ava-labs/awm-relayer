...
func BasicRelay(network interfaces.LocalNetwork) {
	...
	relayerKeyA := database.CalculateRelayerKey(subnetAInfo.BlockchainID, subnetBInfo.BlockchainID, common.Address{}, common.Address{}) // TODONOW: update the src/dst addresses once allow lists added
