...
Currently required configurations are a small subset of the [`icm-relayer` configuration](https://github.com/ava-labs/icm-relayer?tab=readme-ov-file#configuration).
